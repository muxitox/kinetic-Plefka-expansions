...
from plefka import update_m_P_t1_t_o2, update_D_P_t1_t_o2, update_m_P_t_o2, update_D_P_t_o2, update_m_P_CMS
...
for ib in range(B):
    ...
    while cond:
        I.m_p = mp_mean
        I.C_p = Cp_mean
        I.m, I.D = update_m_P_CMS(I.H, I.J, I.m_p, I.C_p)
        DH = m_mean - I.m
        DJ = D_mean - I.D
        I.J += etaJ * DJ
        I.H += etaH * DH
        ...
        print('P_CMS', beta_ref, rep, nsf(error_H), nsf(error_J),
...
# Run Plefka[t-1,t], order 2 TAP
    ...
    np.savez_compressed(filename,
                        H=H, J=J,
                        HP_t1_t=HP_t1_t, HP_t1=HP_t1, HP2_t=HP_CMS,
                        JP_t1_t=JP_t1_t,  JP_t1=JP_t1, JP2_t=JP_CMS,
                        time_P_t1_t=time_P_t1_t,
                        time_P_t1=time_P_t1,
                        time_P2_t=time_P_CMS)
